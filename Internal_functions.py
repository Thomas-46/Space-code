...
class Satellite:
    ...
    def __init__(self,a,e,i,OMEGA,w,M):
        self.a = a
        self.e = e
        self.i = i
        self.OMEGA = OMEGA
    ...
    def get_state_vector(self):
        """Retourne le vecteur d'état [a,e,i,OMEGA,w,M]"""
        return np.array([self.a, self.e, self.i, self.OMEGA, self.w, self.M])

    def set_state_vector(self, state_vector):
        """Met à jour les éléments orbitaux à partir du vecteur d'état"""
        self.a, self.e, self.i, self.OMEGA, self.w, self.M = state_vector
...
def compute_accel_sun_norm(R, t):
    """
    R : [x, y, z, vx, vy, vz]
    ...
    accel = get_keplerian_acceleration(pos, M_Soleil_norm, G_norm)
